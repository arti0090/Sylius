...
Feature: Adding a product with selected variant with discounted catalog price to the cart
    ...
    @todo
    Scenario: Adding multiple product variants with discounted variant by catalog promotion catalog to the cart
        ...
        And And I should see "PHP T-Shirt" with unit price "$15.00" in my cart
